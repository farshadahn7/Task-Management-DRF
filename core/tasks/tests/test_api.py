...
@pytest.fixture
def test_user():
    return CustomUser.objects.create(username='test', email='test@test.com', password='123456@a')


@pytest.fixture
def test_superuser():
    return CustomUser.objects.create(username='test', email='test@test.com', password='123456@a', is_staff=True)
